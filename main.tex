...
\author{ Ashish kumar mal,  } % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\textsc{\Large M Thesis}\\[0.5cm] % Thesis type
