...
\thesistitle{G'day! we are here in your class with  paul  lets gett rolling !!} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\author{ cody, shdvwjh ceao of foofbanks } % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
