...
\thesistitle{Research Proposal} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\author{ Ashish kumar mal \\
FAN :mal001 \\ Student ID: 2195903}% Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\large \textit{Group members:-- \\
Dilrukshie Vasana Tennakoon Mudiyanselage,\\ Rajinder Kaur.} \\

\large \textit{\\
A thesis submitted in fulfilment of the requirements\\ for the degree of \degreename}\\[0.4cm] % University requirement text
...
\noindent I, Ashish Kumar Mal, declare that this thesis titled, \enquote{\ttitle} and the work presented in it are my own. I confirm that:
